...
public interface UserService {
    ...
    // 登录
    BaseBean login(String account, String password);

    //注册
    BaseBean addUserInfo(String phone, String password, String userName);

    // 通过id查询用户信息
    BaseBean getUserInfoById(String userId);

    // 通过账号查询用户是否注册
    boolean getPhoneIsRegist(String phone);
}